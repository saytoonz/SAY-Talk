...
import com.nsromapa.frenzapp.saytalk.fragments.FragmentOnlineFriends
        ...
        asyncLoader = doAsyncResult {
            ...
            activityUiThread {
                ...
                if(FirebaseUtils.isLoggedIn()) {
                    ...
                    userInfo.email = "saytoonz05@gmail.com"
                    try {
                            ...
                            .addValueEventListener(object : ValueEventListener {
                                ...
                                override fun onDataChange(p0: DataSnapshot) {
                                    if (p0.exists()) {
                                        ...
                                        userInfo.avatar = URL(p0.getValue().toString())

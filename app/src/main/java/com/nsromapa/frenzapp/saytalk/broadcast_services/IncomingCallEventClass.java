package com.nsromapa.frenzapp.saytalk.broadcast_services;
...
import com.nsromapa.frenzapp.saytalk.activities.IncomingCallActivity;
...
public class IncomingCallEventClass {
    ...
    private String myUid = FirebaseUtils.INSTANCE.getUid();
        ...
        if (callSnapshot.hasChild("call_initiated_time") &&
            ...
            if (currentTime>(initiatedTime+600000)){
                ...
                if (Objects.requireNonNull(callSnapshot.child("call_status").getValue()).toString()
                    ...
                    switch (PhoneStateBroadcastReciever.phoneState) {

package com.nsromapa.frenzapp.saytalk.utils
...
import com.nsromapa.frenzapp.saytalk.activities.ImagePreviewActivity
import com.nsromapa.frenzapp.saytalk.activities.MessageActivity
import com.nsromapa.frenzapp.saytalk.models.Models
import com.nsromapa.frenzapp.saytalk.utils.FirebaseUtils.ref.user
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.*
import com.squareup.picasso.Picasso
import com.nsromapa.frenzapp.R
import com.nsromapa.frenzapp.saytalk.activities.UserProfileActivity
import com.nsromapa.frenzapp.saytalk.utils.FirebaseUtils.ref.allMessageStatus
...
//                                                MemoryPolicy.NO_STORE)
    ...
    fun setUserOnlineStatus(context: Context, uid: String, textView: TextView) {
        ...
        FirebaseUtils.ref.userStatus(uid)
            .addValueEventListener(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError) {
                }
    ...
    fun updateFCMToken() {
        FirebaseInstanceId.getInstance()
            ...
            .addOnCompleteListener {
                ...
                FirebaseUtils.ref.FCMToken(getUid())
                    .child(it.result!!.id)
    ...
    fun setMuteImageIcon(uid: String, imageView: ImageView) {
        imageView.visibility = View.GONE
        FirebaseUtils.ref.notificationMute(uid)
            .addValueEventListener(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError) {
                }
        ...
        FirebaseDatabase.getInstance().getReference(key_app_code)
            .addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    ...
                    Log.d(
                        "FirebaseUtils",
                        "onDataChange: current version = ${com.nsromapa.frenzapp.BuildConfig.VERSION_CODE}"
                    )
                    Log.d("FirebaseUtils", "onDataChange: available version = $versionCode")

                    if (versionCode > com.nsromapa.frenzapp.BuildConfig.VERSION_CODE) {
                        //show update dialog
                        context.alert {
            ...
            when (i) {
                ...
                0 -> {
                    if (!isMeAdmin)
                        ...
                        context.alert {
                            message = if (isAdmin) "Dismiss ${utils.getNameFromNumber(
                                context,
                                phoneNumber
                            )} from admin?"

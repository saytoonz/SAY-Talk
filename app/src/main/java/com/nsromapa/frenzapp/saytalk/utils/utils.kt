...
object utils {
    ...
    object constants {
        ...
        const val SHARING_TEXT = "Download FrenzApp - A completely free & realtime call, news feed,chat, etc app, for I use it to connect to my love ones\n\nClick to Download : $APP_SHORT_LINK"
        ...
        return try {
            ...
            if (Build.VERSION.SDK_INT >= 24)
                uri = FileProvider.getUriForFile(context!!,
                    utils.constants.URI_AUTHORITY, file)
